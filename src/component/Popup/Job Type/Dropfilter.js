                ...
                <form className=" w-100 fromjobdata">
                    ...
                    <div className="w-100">
                        <Box className="w-100">
                            ...
                            <Box sx={{ m: 3 }} />
                            <Typography gutterBottom className='mb-4 headinglabel'>Price Range</Typography>
                            <PrettoSlider
                     ...
                     <div className="w-100">
                        <Box className="w-100">
                            ...
                            <Box sx={{ m: 3 }} />
                            <Typography gutterBottom className='mb-4 headinglabel'>Experience required</Typography>
                            <PrettoSlider
                                valueLabelDisplay="on"
                                // aria-label="pretto slider"
                                defaultValue={[3, 6]}
