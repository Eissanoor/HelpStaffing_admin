...
function Collegeedit() {
  ...
  const apicall = () => {
    ...
    axios.put(
        `/admin/college/`, {
          _id: sessionStorage.getItem('Qualificationeditid'),
          name:name,
          icon:icon,
          status: true,
        },
  ...
  const Update = () => {
    ...
    const Deletedapi = (id) => {
      //  console.log(id);
      const iddelet = sessionStorage.getItem("Qualificationeditid");
      axios
        .delete(`/admin/college?id=${iddelet}`, {
          headers: {
        ...
        <DialogContent>
          <DialogContentText >
            <input
              ...
              id="Assistant"
              value = {
                sessionStorage.getItem('Qualificationeditname')
              }
