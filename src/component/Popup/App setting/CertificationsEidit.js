...
function CertificationsEidit() {
  ...
  const apicall = () => {
    const _id = sessionStorage.getItem("certificationid");
    ...
    axios
      .put(
        `/admin/certification/`,
        {
          _id: sessionStorage.getItem("certificationid"),
          name: sessionStorage.getItem("certificationname"),
          status: status,
        },
        {
          headers: {
  ...
  const Deletedapi = (id) => {
      //  console.log(id);
      const iddelet = sessionStorage.getItem("certificationid");
      axios
          .delete(`/admin/certification?id=${iddelet}`, {
              headers: {
          ...
          <DialogContent>
            <DialogContentText>
              <input
                ...
                id="Assistant"
                value = {
                    sessionStorage.getItem("certificationname")
                }
...
export default CertificationsEidit;
