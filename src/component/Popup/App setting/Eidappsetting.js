...
function Eidappsetting() {
  ...
  const apicall = () => {
    ...
    axios.put(
        `/admin/category/`,{
          _id: sessionStorage.getItem('idget'),
          name:name,
          icon:icon,
          status: true,
        },
  ...
  const Update = () => {
    ...
    const Deletedapi = (id) => {
      //  console.log(id);
      const iddelet = sessionStorage.getItem("idget");
      axios
        .delete(`/admin/category?id=${iddelet}`, {
          headers: {
