...
import Charles from "../../../Assets/image/Charles.svg";
                ...
                <div className="bg">
                    <div className="">
                        <Box sx={{ display: "flex" }}>
                            ...
                            >
                                <div calssName="mainContractDetails mt-5">
                                    {/* TOp section */}
                                    <div className="row mt-5 bg-white p-2 mx-auto rounded">
                                    ...
                                    {/*  */}
                                    <div className='w-100 p-2 mt-3 bg-white  mainalljob rounded '>
                                        <Comment
                                            //   actions={actions}
                                            author={
                                                <div className=' p-2 '>
                                                    <h6 className='authorname fontfamily text-black'>Need a Cardiologist, MBBS, FCPS doctor in our Hospital</h6>
                                                    <p className='authordetail fontfamily '>Job Posted 2min ago</p>
                                                    <div className='d-flex'>
                                            ...
                                            content={
                                                <>
                                                    ...
                                                    <div className='d-flex justify-content-between mt-3 me-2 w-100 h-100 overflow-auto p-3'>
                        ...
                        <span className='fontfamily'><span className='firstsec text-black   bolder'>Evening </span>/ Shift</span>
                                    ...
                                    {/*  */}
                                    {/* Top card section */}
                                    <div className="row  mt-3 bg-white rounded p-2 py-3  mx-auto">
                                        <div className="col-sm-4 col-md-4 col-lg-3 col-xl-3 my-2">
                                            <div className='d-flex'>
                                    ...
                                    {/*  */}
                                    {/* image section */}
                                    <div className="row mt-3 rounded bg-white p-2 mx-auto">
                                    ...
                                    {/*  */}
                                    {/* TOp section */}
                                    <div className="row mt-3 bg-white p-2 mx-auto rounded">
                                        <h6 className='PostedBy'>Hired</h6>
                                        <div className="col-sm-4 col-md-4 col-lg-3 col-xl-3 my-2">
                                            <div className='d-flex'>
                                                <img src={Charles} height='30px' />
                                                <h6 className='Jobdetailsnumber text-black ms-2'>Will Charles</h6>

                                            </div>
                                            <p className='Jobdetailsheading'>Cardiologist</p>
                                        </div>
                                        <div className="col-sm-4 col-md-4 col-lg-3 col-xl-3 my-2">
                                            <div className='d-flex'>
                                                <img src={Location} height='30px' />
                                        ...
                                        <div className="col-sm-4 col-md-4 col-lg-3 col-xl-3 my-2">
                                            <div className='d-flex'>
                                                <img src={Totaljobs} height='30px' />
                                                <h6 className='Jobdetailsnumber text-black ms-2'>94</h6>

                                            </div>
                                            <p className='Jobdetailsheading'>Completed Jobs</p>
                                        </div>
                                        <div className="col-sm-4 col-md-4 col-lg-3 col-xl-3 my-2">
                                            <div className='d-flex'>
                                                <img src={HiringRates} height='30px' />
                                            ...
                                            <p className='Jobdetailsheading'>Jobs Completion</p>
                                        </div>

                                    </div>
                                    {/*  */}
                                    {/* Button */}
                                    <button className="w-100 Ongoingjobbtn fontfamilyInter rounded border-0 text-white py-2 mt-3">Ongoing Job</button>
                                </div>
                            </Box>
