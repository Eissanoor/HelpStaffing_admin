...
// Main fuction of the compount
  const apicall = () => {
    axios
      .get(`/admin/degree-level?page=1&limit=10`, {
        headers: {
          secretKey:
...
// 
 // Deleted api section
   const Deletedapi = (_id) => {
     console.log(_id);
     axios
       .delete(`/admin/degree-level?id=${_id}`, {
         headers: {
                  ...
                  <TableRow className="" key="index">
                    ...
                    >
                      <div className=" d-flex pt-2  w-100 justify-content-end rounded my-auto">
                        ...
                        onClick = {
                            () => {
                                sessionStorage.setItem('Qualificationdegreeseditid', dataget[itme]._id);
                                sessionStorage.setItem("Qualificationdegreesname", dataget[itme].name);
