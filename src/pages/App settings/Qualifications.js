...
// Main fuction of the compount
  const apicall = () => {
    axios
      .get(`/admin/college?page=1&limit=10`, {
        headers: {
          secretKey:
          ...
          <div className="px-2">
            <div>
              <p className="specialitypro pt-3 fontstyle fontfamilyRoboto">
                Add a college or university name{" "}
                  ...
                  <TableRow className="" key="index">
                    ...
                    >
                      <div className=" d-flex pt-2  w-100 justify-content-end rounded my-auto">
                        ...
                        onClick = {
                            () => {
                                sessionStorage.setItem('Qualificationeditid', dataget[itme]._id);
                                sessionStorage.setItem("Qualificationeditname", dataget[itme].name);
