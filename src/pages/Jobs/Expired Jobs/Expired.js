...
import TestTaken from '../../../Assets/image/Hourly rate.png'
                  ...
                  content={
                    <>
                      ...
                      <div className='d-flex  mt-3 me-2'>
                        <span className='fontfamily me-3'><span className='firstsec  text-black bolder' >$95.00 </span>/  hour</span>
                        |
                        <span className='fontfamily mx-3'><span className='firstsec  text-black bolder' >2weeks</span>/ Duration</span>
                        |
                        <span className='fontfamily mx-3'><span className='firstsec  text-black bolder' >2 years </span> experience</span>
                        |
                        <span className='fontfamily mx-3'><span className='firstsec  text-black bolder' >26hrs</span>/week </span>
                        |
                        <span className='fontfamily mx-3'><span className='bolder' ><img src={TestTaken} /></span><span className='TestTaken mx-1 bolder'>Test Taken</span></span>
                    ...
                    <Tooltip >
                      <span>
                        <div className='alljobactionimag d-flex justify-content-around py-1 mt-auto w-100 px-2 rounded '>
                          <img className="cursor px-1 my-auto" onClick={() => {
                            //   navigate("/DraftDetails");
                          }} src={eye} height="25px"/>
                          {/* <img  className="cursor px-2" src={deleteicon} /> */}
                          <p className='px-1 my-auto'><Delete /></p>
                        </div>
                      </span>
                    </Tooltip>
                  }
